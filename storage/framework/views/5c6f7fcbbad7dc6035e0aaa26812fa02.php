<?php $__env->startSection('title', 'Cotizador Online & Reservas | High Contrast Detailing Center'); ?>
<?php $__env->startSection('meta_description', 'Cotiza y agenda el detallado automotriz de tu vehículo online. Chicureo, Colina.'); ?>
<?php $__env->startSection('meta_keywords', 'cotizar detailing online, agendar detailing chicureo, reserva detailing santiago, precios detailing colina, cotizador detailing'); ?>
...
function bookingWizard() {
    return {
        ...
        vehicleTypes: <?php echo json_encode($vehicleTypes, 15, 512) ?>,
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\detailing-laravel\resources\views/reserva.blade.php ENDPATH**/ ?>