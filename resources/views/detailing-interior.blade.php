...
<main class="overflow-hidden bg-white dark:bg-surface-900 text-black dark:text-white transition-colors duration-300">
    ...
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0A0A0A]">
        <div class="absolute inset-0 bg-[#0A0A0A]">
            @php
                $interiorVideo = file_exists(public_path('assets/videos/interior.mp4'))
    ...
    <section class="py-20 relative bg-zinc-950 text-white overflow-hidden text-center border-t border-white/10">
        <div class="container-custom relative z-10 max-w-3xl mx-auto px-4">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $profile->whatsapp ?? $profile->phone ?? '56951024782') }}?text={{ urlencode('Hola! Quisiera consultar por el servicio de Detailing Interior a Vapor en Las Condes/Chicureo.') }}" target="_blank" rel="noopener noreferrer" class="w-full sm:w-auto px-8 py-4.5 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-base rounded-full shadow-lg transition-all flex items-center justify-center gap-2">
